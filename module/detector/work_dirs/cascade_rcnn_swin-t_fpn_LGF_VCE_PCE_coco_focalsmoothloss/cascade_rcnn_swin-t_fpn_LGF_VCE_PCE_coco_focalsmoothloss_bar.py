...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        './data/pmc_2022/pmc_coco/plots_detection/baronly_train.json',
        img_prefix=
        './data/pmc_2022/pmc_coco/plots_detection/bar_images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        './data/pmc_2022/pmc_coco/plots_detection/baronly_val.json',
        img_prefix=
        './data/pmc_2022/pmc_coco/plots_detection/bar_images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        './data/pmc_2022/pmc_coco/plots_detection/baronly_test.json',
        img_prefix=
        './data/pmc_2022/pmc_coco/plots_detection/bar_test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
classes = ['bar']
work_dir = './work_dirs/cascade_rcnn_swin-t_fpn_LGM_SENet_BboxEncoding_coco_customizeloss/'
auto_resume = False
gpu_ids = range(0, 4)
