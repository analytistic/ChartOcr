...
if __name__ == "__main__":
    ...
    """
    result0 = detector.predict('/Users/alex/project/chartocr/ChartOcr/data/input/2.jpg')
    ...
    ChartDetector.plot(detector.model, '/Users/alex/project/chartocr/ChartOcr/data/input/2.jpg', result0, score_thr=0.3, out_file='result_pre.jpg')
    ChartDetector.plot(detector.model, '/Users/alex/project/chartocr/ChartOcr/data/input/2.jpg', result1, score_thr=0.3, out_file='result_post.jpg')