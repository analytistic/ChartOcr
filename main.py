...
if __name__ == "__main__":
    ...
    """
    result0 = detector.predict('/Users/alex/project/chartocr/ChartOcr/data/input/5.jpg')
    img = mmcv.imread('/Users/alex/project/chartocr/ChartOcr/data/input/5.jpg')
    result0 = [r.copy()  for r in result0]
    result0[15] = np.empty((0, 5))
    result = detector.getjson('/Users/alex/project/chartocr/ChartOcr/data/input/5.jpg')
